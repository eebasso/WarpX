...
FlushFormatCheckpoint::WriteDMaps (const std::string& dir, int nlev) const
{
    if (amrex::ParallelDescriptor::IOProcessor()) {
        ...
        for (int lev = 0; lev < nlev; ++lev) {
            ...
            DMFile << amrex::ParallelDescriptor::NProcs() << "\n";
