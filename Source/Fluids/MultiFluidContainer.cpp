...
void
MultiFluidContainer::AllocateLevelMFs (int lev, const amrex::BoxArray& ba, const amrex::DistributionMapping& dm)
{
...
MultiFluidContainer::Evolve (int lev,
                            ...
                            MultiFab* rho, amrex::MultiFab& jx, amrex::MultiFab& jy, amrex::MultiFab& jz,
